        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-600">오늘도 열심히 공부해보세요 ✨</p>
            </div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-gray-400 mt-2">스터디를 만들거나 참여해보세요!</p>
                  </div>
                </CardContent>
              </Card>
            </div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-center py-4">
                    <p className="text-gray-500 text-sm">참여 중인 스터디가 없습니다.</p>
                  </div>
                </CardContent>
              </Card>
